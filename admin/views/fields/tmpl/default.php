		...
		<table class="table table-striped table-hover">
			<thead>
				<tr>
					...
					?>
						<th width="5%"><?php echo JHtml::_('searchtools.sort', 'COM_QATDATABASE_FIELD_STATUS', 'field.published', $listDirn, $listOrder); ?></th>
					<?php
					}
					?>
					<th><?php echo JHtml::_('searchtools.sort', 'COM_QATDATABASE_ITEM_TITLE', 'field.title', $listDirn, $listOrder); ?></th>
					<th><?php echo JHtml::_('searchtools.sort', 'COM_QATDATABASE_FIELD_NAME_LIST', 'field.name', $listDirn, $listOrder); ?></th>
					<th><?php echo JHtml::_('searchtools.sort', 'COM_QATDATABASE_FIELD_TYPE', 'field.type', $listDirn, $listOrder); ?></th>
					<th><?php echo JHtml::_('searchtools.sort', 'COM_QATDATABASE_FIELD_CATEGORY', 'field.catid', $listDirn, $listOrder); ?></th>
					<th><?php echo JHtml::_('searchtools.sort', 'COM_QATDATABASE_ID', 'field.id', $listDirn, $listOrder); ?></th>
				</tr>
			</thead>
			<tfoot>
				<tr>
